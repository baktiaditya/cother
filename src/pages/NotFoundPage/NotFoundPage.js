...
class ErrorPage extends React.Component {
  ...
  componentWillMount() {
    // Page title
    document.getElementsByTagName('title')[0].innerHTML = `${PAGE_TITLE_PREFIX} ${PAGE_TITLE_SEP} ${this._pageTitle}`;
  ...
  render() {
    return (
      <Base>
        ...
        <p className={scss['caption']}>Sorry, but the page you were trying to view does not exist.</p>
      </Base>
    );
  }
}
